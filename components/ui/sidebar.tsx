  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "flex h-full w-(--sidebar-width) md:w-(--sidebar-width-tablet) flex-col bg-sidebar text-sidebar-foreground",
          className
        )}
        {...props}
      >

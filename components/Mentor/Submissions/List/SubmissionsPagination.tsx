  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 items-center justify-between w-full mt-4 select-none">
      ...
      <div className="relative order-3" ref={sizeRef}>
        ...
        >
          <span>
            {t("pagination.show_per_page")} {itemsPerPage}
          </span>
          <ChevronDown
        ...
        {isSizeOpen && (
          <div
            className={`absolute z-35 bottom-full mb-1 w-24 bg-white border border-slate-150 rounded-xl shadow-xl p-1 animate-in fade-in duration-200 ${

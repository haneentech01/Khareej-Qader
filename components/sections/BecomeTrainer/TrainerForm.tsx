...
import { CloudUpload, EyeIcon, EyeOff } from "lucide-react";
...
export function TrainerForm() {
  ...
  return (
    <div className="relative mx-6">
      <div className="absolute w-[110%] md:w-[110%] 
      h-[103%] md:h-[105%] 
      max-w-[630px] -top-5 -left-4 md:-right-6
      -rotate-2 bg-[#006B560D] rounded-[40px] z-10" />

      <div className="relative bg-white p-8 rounded-4xl 
      border border-slate-50
       w-full max-w-[636px] mx-auto z-20">
